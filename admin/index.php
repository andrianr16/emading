...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Manajemen Artikel</h4>
                  ...
                  <tr class="text-center">
                    ...
                    <td>
                      <a href="../files/<?= $row['header']; ?>" target="_blank">
                        <img src="../files/<?= $row['header']; ?>" class="img-thumbnail rounded" style="max-width: 100px;">
                      </a>
                    </td>
                    ...
                    <td>
                      <a href="ubah.php" class="btn btn-sm btn-warning">Ubah</a>
